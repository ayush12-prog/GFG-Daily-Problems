<h2><a href="https://www.geeksforgeeks.org/problems/minimum-time1238/1?_gl=1*k9bdbk*_up*MQ..*_gs*MQ..&gclid=EAIaIQobChMI3Pr-taejjgMVKF0PAh2ogQAHEAAYASAAEgJbLPD_BwE">Minimum Cost for n Characters</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given four integers <strong>n</strong>, <strong>i</strong>, <strong>d</strong>, and <strong>c</strong>, where:</span></p>
<ul>
