<h2><a href="https://www.geeksforgeeks.org/problems/replace-os-with-xs0052/1?_gl=1*c0768*_up*MQ..*_gs*MQ..&gclid=EAIaIQobChMI3Pr-taejjgMVKF0PAh2ogQAHEAAYASAAEgJbLPD_BwE">Replace O's with X's</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a <strong>grid[][] </strong>of size n*m, where every element is either 'O' or 'X'. You have to <strong>replace</strong> all 'O' or a group of 'O' with 'X' that are surrounded by 'X'. </span></p>
