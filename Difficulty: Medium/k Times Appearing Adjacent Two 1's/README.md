<h2><a href="https://www.geeksforgeeks.org/problems/count-binary-strings1944/1?_gl=1*athx3i*_up*MQ..*_gs*MQ..&gclid=EAIaIQobChMI3Pr-taejjgMVKF0PAh2ogQAHEAAYASAAEgJbLPD_BwE">k Times Appearing Adjacent Two 1's</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given two integers <strong>n</strong> and <strong>k</strong>, count the number of binary strings of length n where adjacent 1 appear k times. </span></p>
