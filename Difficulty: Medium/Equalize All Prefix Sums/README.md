<h2><a href="https://www.geeksforgeeks.org/problems/optimal-array--170647/1?_gl=1*100rcpk*_up*MQ..*_gs*MQ..&gclid=EAIaIQobChMI3Pr-taejjgMVKF0PAh2ogQAHEAAYASAAEgJbLPD_BwE">Equalize All Prefix Sums</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a <strong>sorted </strong>array <strong>arr[]</strong>. For each i(0 ≤ i ≤ n-1), make all the elements of the array from index 0 to i <strong>equal</strong>, using the <strong>minimum</strong> number of <strong>operations</strong>. </span></p>
