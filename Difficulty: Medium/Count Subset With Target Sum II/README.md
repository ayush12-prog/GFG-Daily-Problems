<h2><a href="https://www.geeksforgeeks.org/problems/count-the-subset-with-sum-equal-to-k/1?_gl=1*1ei6y1b*_up*MQ..*_gs*MQ..&gclid=EAIaIQobChMI3Pr-taejjgMVKF0PAh2ogQAHEAAYASAAEgJbLPD_BwE">Count Subset With Target Sum II</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> and an integer <strong>k</strong>, find the count of <strong>subsets</strong> whose sum is equals to k.</span></p>
