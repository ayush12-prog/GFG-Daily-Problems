<h2><a href="https://www.geeksforgeeks.org/problems/high-effort-vs-low-effort0213/1?_gl=1*rhcng7*_up*MQ..*_gs*MQ..&gclid=EAIaIQobChMI3Pr-taejjgMVKF0PAh2ogQAHEAAYASAAEgJbLPD_BwE">High Effort vs Low Effort</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given two integer arrays <strong>h[]</strong> and <strong>l[]</strong>, where h[i] and l[i] denote the number of tasks that can be completed on the<strong> i-th </strong>day by performing a high-effort task and a low-effort task, respectively.</span></p>
