<h2><a href="https://www.geeksforgeeks.org/problems/last-coin-in-a-game-of-alternates/1?_gl=1*n8r8uw*_up*MQ..*_gs*MQ..&gclid=EAIaIQobChMI3Pr-taejjgMVKF0PAh2ogQAHEAAYASAAEgJbLPD_BwE">Last Coin in a Game of Alternates</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p data-pm-slice="0 0 []"><span style="font-size: 18.6667px;">Given an array integer<strong> arr[]</strong> , representing the values of coins arranged in a row.</span></p>
<ul>
