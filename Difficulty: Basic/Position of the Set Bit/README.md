<h2><a href="https://www.geeksforgeeks.org/problems/find-position-of-set-bit3706/1?_gl=1*1dl564u*_up*MQ..*_gs*MQ..&gclid=EAIaIQobChMI3Pr-taejjgMVKF0PAh2ogQAHEAAYASAAEgJbLPD_BwE">Position of the Set Bit</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an integer&nbsp;<strong>n</strong>, determine position of the <strong>only set bit&nbsp;</strong>(1) in its binary representation. The position is counted starting from 1 at the least significant bit (LSB).</span></p>
<ul>
