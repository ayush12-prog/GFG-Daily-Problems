<h2><a href="https://www.geeksforgeeks.org/problems/rearrange-the-array-1639032648/1?_gl=1*wh1dm8*_up*MQ..*_gs*MQ..&gclid=EAIaIQobChMI3Pr-taejjgMVKF0PAh2ogQAHEAAYASAAEgJbLPD_BwE">Rearrange the Array</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Consider an array<strong> </strong></span><span style="font-size: 18px;"><strong>a[]</strong> = [1, 2, 3, ..., n] and a permutation <strong>b[]</strong> of size n containing all integers from 1 to n exactly once.</span></p>
<ul>
