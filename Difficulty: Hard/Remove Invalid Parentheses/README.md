<h2><a href="https://www.geeksforgeeks.org/problems/remove-invalid-parentheses/1?_gl=1*rue41l*_up*MQ..*_gs*MQ..&gclid=EAIaIQobChMI3Pr-taejjgMVKF0PAh2ogQAHEAAYASAAEgJbLPD_BwE">Remove Invalid Parentheses</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a string <strong>s</strong> consisting of lowercase letters and parentheses '(' and ')'.</span></p>
