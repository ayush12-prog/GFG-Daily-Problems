<h2><a href="https://www.geeksforgeeks.org/problems/chocolates-pickup/1?_gl=1*99spvu*_up*MQ..*_gs*MQ..&gclid=EAIaIQobChMI3Pr-taejjgMVKF0PAh2ogQAHEAAYASAAEgJbLPD_BwE">Chocolates Pickup</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a 2D matrix <strong>grid[][]</strong> of size <strong>n*m</strong>,&nbsp;</span><span style="font-size: 18px;">where each cell <strong>grid[i][j]</strong> represents the number of chocolates available at position <strong>(i, j)</strong>.</span></p>
